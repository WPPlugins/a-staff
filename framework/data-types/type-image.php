...
class TPL_Image extends TPL_Data_Type {
	...
	public function form_field_content ( $for_bank = false ) {
		...
		echo '	<div class="tpl-image-container">
					<img class="tpl-uploaded-image" alt="' . sprintf( __( '%s image tag', 'themple' ), esc_attr( $this->title ) ) . '" src="' . esc_url( $imgdata[0] ) . '"';
		...
		echo '">
						<span class="tpl-hovermsg"><span class="tpl-hovermsg-inner">'. __( 'Click here to remove image.', 'themple' ) .'</span></span>
					</div>
				</div>
